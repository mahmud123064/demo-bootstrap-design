...
const Navbar = () => {
    ...
    return (
        <div className="supper_container">

            <Helmet>
                <script src='./navbarScript.js' type="text/javascript" />
            </Helmet>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col d-flex flex-row">
                                <div className="top_bar_contact_item"><div className="top_bar_icon"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918577/phone.png" alt="" /></div> 240-449-6311</div>
                                <div className="top_bar_contact_item"><div className="top_bar_icon"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918597/mail.png" alt="" /></div><a href="mailto:fastsales@gmail.com">contact@legoio.com</a></div>
                                <div className="top_bar_contact_item"><div className="top_bar_icon"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918597/mail.png" alt="" /></div><a href="mailto:fastsales@gmail.com">contact@legoio.com</a></div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-2 col-sm-3 col-3 order-1">
                                <div className="logo_container">
                                    <div className="logo"><a href="#">Platform</a></div>
                                </div>
                            </div>
                                    ...
                                    <div className="main_nav_menu">
                                        <ul className="standard_dropdown main_nav_dropdown">
                                            ...
                                            <li className="hassubs">
                                                <a href="#">Laptop<i className="fas fa-chevron-down"></i></a>
                                                <ul>
                                                    <li>
                                                        <a href="#">Lenovo<i className="fas fa-chevron-down"></i></a>
                                                        <ul>
                                                            <li><a href="#">Lenovo 1<i className="fas fa-chevron-down"></i></a></li>
                                                            <li><a href="#">Lenovo 3<i className="fas fa-chevron-down"></i></a></li>
                                                            <li><a href="#">Lenovo 2<i className="fas fa-chevron-down"></i></a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="#">DELL<i className="fas fa-chevron-down"></i></a></li>
                                                    <li><a href="#">APPLE<i className="fas fa-chevron-down"></i></a></li>
                                                    <li><a href="#">HP<i className="fas fa-chevron-down"></i></a></li>
                                                </ul>
                                            </li>
                                            <li className="hassubs">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="#">APPLE<i className="fas fa-chevron-down"></i></a>
                                                        <ul>
                                                            <li><a href="#">Laptop<i className="fas fa-chevron-down"></i></a></li>
                                                            <li><a href="#">Mobiles<i className="fas fa-chevron-down"></i></a></li>
                                                            <li><a href="#">Ipads<i className="fas fa-chevron-down"></i></a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="#">Samsung<i className="fas fa-chevron-down"></i></a></li>
                                                    <li><a href="#">Lenovo<i className="fas fa-chevron-down"></i></a></li>
                                                    <li><a href="#">DELL<i className="fas fa-chevron-down"></i></a></li>
                                                </ul>
                                            </li>
                                            <li className="hassubs">
                            ...
                            <div className="col">
                                ...
                                <div className="page_menu_content">
                                    ...
                                    <div className="menu_contact">
                                        <div className="menu_contact_item"><div className="menu_contact_icon">
                                            <img src="images/phone_white.png" alt="" />
                                        </div>+38 068 005 3570</div>
